...
public class BTree {
	...
	/**
	 * Creates a BTree Object from a raf and loads in the root
	 * This method should only be called if you're only searching the tree. This is not for editing
	 * @param raf
	 * @throws Exception
	 */
	public BTree(RandomAccessFile raf) throws Exception {
